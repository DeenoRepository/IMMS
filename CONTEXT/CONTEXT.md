...
- Design system package `@mech/ui` created with core CSS variables (tokens) and base components (`Button`, `Input`, `Card`).
...
- `task-mech-ui-init`: Design System Package (@mech/ui) Setup
